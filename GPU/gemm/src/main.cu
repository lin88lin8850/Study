...
void kernel_1_launch(sgemm_params device_sgemm_params, KernelLogger& timer,
                     const unsigned int num_runs);
void kernel_2_launch(sgemm_params device_sgemm_params, KernelLogger& timer,
                     const unsigned int num_runs);
void kernel_3_launch(sgemm_params device_sgemm_params, KernelLogger& timer,
                     const unsigned int num_runs);
void kernel_4_launch(sgemm_params device_sgemm_params, KernelLogger& timer,
                     const unsigned int num_runs);
void kernel_5_launch(sgemm_params device_sgemm_params, KernelLogger& timer,
                     const unsigned int num_runs);
void kernel_6_launch(sgemm_params device_sgemm_params, KernelLogger& timer,
                     const unsigned int num_runs);
...
int main(int argc, char** argv) {
  if (argc != 7) {
    std::cerr << "Usage: " << argv[0]
              << " <kernel_id> <num_iterations> <M> <N> <K>" << std::endl;
    return 1;
  }
  ...
  bool check_acc = (std::string(argv[6]) == "true");
  ...
  switch (kernel_id) {
    case 0:
      kernel_0_launch(device_sgemm_params, timer, num_iterations);
      break;
    case 1:
